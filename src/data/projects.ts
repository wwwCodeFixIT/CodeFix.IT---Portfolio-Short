...
export const projects: Project[] = [
  {
    id: 1,
    title: "eM-aiR System",
    shortDescription: "Strona dla firmy zajmującej się klimatyzacją i wentylacją. Kompleksowa przebudowa istniejącej witryny.",
...
Projekt obejmował responsywny design, optymalizację pod kątem SEO oraz integrację z Google Maps dla lokalizacji firmy.`,
  ...
  },
  {
    ...
    shortDescription: "Profesjonalna strona wizytówka dla rzeczoznawcy samochodowego. Stworzona od zera z pełną integracją analityki.",
...
Strona zawiera integrację z Google Analytics do śledzenia ruchu oraz zoptymalizowane formularze kontaktowe. Design jest profesjonalny i budzi zaufanie - kluczowe dla branży rzeczoznawczej.`,
  ...
  },
  {
    ...
    shortDescription: "Elegancka strona dla kancelarii adwokackiej. Projekt zrealizowany we współpracy z SyloSoftware.",
...
Design jest elegancki i profesjonalny - idealny dla branży prawniczej. Strona budzi zaufanie i ułatwia potencjalnym klientom kontakt z kancelarią.`,
